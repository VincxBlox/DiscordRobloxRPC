...
def update_discord_rpc(game_name, start_time):
    try:
        rpc.update(
            ...
            large_image="https://static.wikia.nocookie.net/logopedia/images/6/6f/Roblox_app_2022.svg/revision/latest/scale-to-width-down/250?cb=20230413000311",
            small_image="https://static.wikia.nocookie.net/logopedia/images/6/6f/Roblox_app_2022.svg/revision/latest/scale-to-width-down/250?cb=20230413000311",
            start=start_time
        )
